      ...
      <div className="glass-widget" style={{ 
        ...
        {registered ? (
          <div style={{ animation: 'fadeIn 0.5s ease' }}>
            ...
            <h2 style={{ fontSize: '40px', fontWeight: 800, marginBottom: '20px', fontFamily: "'Orbitron', sans-serif" }}>Account Created!</h2>
            <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '18px', lineHeight: 1.6, marginBottom: '40px' }}>
              Welcome to the ultimate terminal for Web3 intelligence. Your journey starts here.
            </p>
            <button 
              onClick={() => navigate('/')}
          ...
          <form onSubmit={handleSubmit} style={{ animation: 'fadeIn 0.5s ease' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '20px', marginBottom: '50px' }}>
              Already have an account? <Link to="/login" style={{ color: '#c084fc', textDecoration: 'none' }}>Log In</Link>
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '30px', textAlign: 'left' }}>
              ...
              <div>
                <label style={{ display: 'block', fontSize: '16px', color: 'rgba(255,255,255,0.5)', marginBottom: '12px', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 600 }}>Confirm Password</label>
                <input 
                  type="password" 
                  required
              ...
              <div style={{ textAlign: 'center', marginTop: '10px' }}>
                <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)' }}>By signing up, you agree to our Terms of Service</span>
              </div>
            </div>
          </form>
        )}
